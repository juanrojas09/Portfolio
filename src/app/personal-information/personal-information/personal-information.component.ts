...
export class PersonalInformationComponent {
  myData: string[][] = [
    ...
    ['Exp Laboral', '1 año'],
    ['Educacion', 'Ingenieria en Sisetams (UCC)'],
  ...
  aboutMe: string[] = [
   ...
   ,'me encuentro cursando mi 5to año de mi carrera, tambien actualmente estoy trabajando como fullstack developer en Encode SA',
